...
async def seed():
    ...
    await db.addon_groups.create_index("restaurant_id")
    await db.addon_groups.create_index([("restaurant_id", 1), ("is_active", 1), ("sort_order", 1)])
    await db.addon_groups.create_index([("restaurant_id", 1), ("product_ids", 1)])
